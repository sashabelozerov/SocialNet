...
map.user_accept_invitation_to_event 'users/:user_id/events/:id/accept', :controller => 'event_users', :action => 'accept_invitation'
map.decline_invitation_to_event 'users/:user_id/events/:id/decline', :controller => 'event_users', :action => 'destroy'
map.tag_user_on_photo 'users/:user_id/photos/:id/tag', :controller => 'photo_users', :action => 'create'
